...
const Headphone = (props) => {
  ...
  const details = [
    ...
    {label:'Form Factor', value:specificproduct.form_factor},
    {label:'Connectivity Technology', value:specificproduct.connectivity_technology},
    {label:'Controls', value:specificproduct.controls},
    {label:'Battery Information', value:specificproduct.battery_information},
