...
const Searchresult = () => {
  ...
  return (
    ...
    <Link to={`/productdetail/${prd._id}`}> <img  src={prd.image && require(`C:/Users/mihir/OneDrive/Desktop/React - Projects/Saturn/saturn/backend/images/${prd.image}`)} className="card-img-top my-3"  />
    </Link>
     <div class="card-body">
